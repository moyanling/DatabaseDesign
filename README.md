...
<br>Premature is the root of all evil. The project is extensible but some codes on infrastructure level are duplicate and since they are processed using String other than my own Object, they are not easy to modify. //TODO learn interface oriented programming
